...
ClientLocking(c) == 
    ...
    /\ IF lockLeaseState = "unlock" 
            THEN 
                 ...
                 /\ lockClientRef' = c
                 /\ UNCHANGED <<storageLastToken, storageState>>
                 
            ELSE 
                /\ clientState' = [clientState EXCEPT ![c] = "failAcquireLock" ]
                /\ UNCHANGED <<lockLeaseState, clientHeldLockState, lockClientRef, lockLastToken, clientFencingToken, storageLastToken, storageState>>
...
ClientWroteData(c) == 
    ...
    /\ storageState' = "notwrite"
    /\ UNCHANGED <<lockLeaseState, clientHeldLockState, lockClientRef, lockLastToken, clientFencingToken, storageLastToken>>
...
ClientReleaseLock(c) ==
    ...
    /\ lockLeaseState' = "unlock"
    /\ lockClientRef' = "noClient"
    /\ UNCHANGED <<lockLastToken, clientFencingToken, storageLastToken, storageState>>
...
LockExpire == 
    ...
    /\ lockLeaseState' = "unlock"
    /\ lockClientRef' = "noClient"
    /\ UNCHANGED <<clientState, clientHeldLockState, lockLastToken, storageLastToken, clientFencingToken, storageState>>
...
Spec == Init /\ [] [Next]_<<clientState, lockLeaseState, clientHeldLockState, lockClientRef, lockLastToken, storageLastToken, clientFencingToken, storageState>>
...
THEOREM Spec => [](TypeOK /\ Consistent2)

=============================================================================
\* Modification History
\* Last modified Sun Jul 31 22:21:58 CST 2022 by wengjialin
