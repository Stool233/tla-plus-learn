...
ClientReleaseLock(c) ==
    ...
    /\ lockLeaseState' = "unlock"
    /\ lockClientRef' = "noClient"
    /\ UNCHANGED <<lockLastToken, clientFencingToken, storageLastToken>>
...
LockExpire == 
    ...
    /\ lockLeaseState' = "unlock"
    /\ lockClientRef' = "noClient"
    /\ UNCHANGED <<clientState, clientHeldLockState, lockLastToken, storageLastToken, clientFencingToken>>
...
Spec == Init /\ [] [Next]_<<clientState, lockLeaseState, clientHeldLockState, lockClientRef, lockLastToken, storageLastToken, clientFencingToken>>
...
\* Last modified Sun Jul 31 22:13:28 CST 2022 by wengjialin
