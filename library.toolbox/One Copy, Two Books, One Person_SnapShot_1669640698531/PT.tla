...
(*
Places an ARBITRARY ordering on the set. Which ordering you get is implementation-dependent but you are guaranteed to always receive the
same ordering.
*)
...
(*
SelectSeq lets you filter a sequence based on a test operator. It acts on the values. SelectSeqByIndex does the exact same, except the operator tests the indices. This is useful if you need to round-robin a thing.
*)
...
\* Last modified Sat Aug 13 17:57:18 CST 2022 by wengjialin
\* Created Sat Aug 13 17:50:33 CST 2022 by wengjialin
