...
fair process incrementer \in 1..2
variable local = 0
begin
    Get:
        local := counter;
...
\* BEGIN TRANSLATION (chksum(pcal) = "87818e8b" /\ chksum(tla) = "f7798f40")
...
Next == (\E self \in 1..2: incrementer(self))
           \/ Terminating

Spec == /\ Init /\ [][Next]_vars
        /\ \A self \in 1..2 : WF_vars(incrementer(self))
...
\* Last modified Sat Sep 17 21:44:20 CST 2022 by wengjialin
