...
\@pvspace{8.0pt}%
\@x{ Pick\@s{3.05} \.{\defeq} \.{\lor}\@s{4.1} \.{\land} pc \.{=}\@w{start}}%
\@x{\@s{57.27} \.{\land} i \.{'}\@s{2.87} \.{\in} 0 \.{\dotdot} 1000}%
\@x{\@s{57.27} \.{\land} pc \.{'} \.{=}\@w{middle}}%
\@pvspace{8.0pt}%
\@x{ Add1 \.{\defeq} \.{\lor}\@s{4.10} \.{\land} pc \.{=}\@w{middle}}%
\@x{\@s{57.27} \.{\land} i \.{'}\@s{2.87} \.{=} i \.{+} 1}%
\@x{\@s{57.27} \.{\land} pc \.{'} \.{=}\@w{done}}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 07 13:11:06 \ensuremath{CST} 2022 by \ensuremath{wengjialin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Tue} \ensuremath{Jun} 07
 13:00:52 \ensuremath{CST} 2022 by \ensuremath{wengjialin
}%
\end{cpar}%
\end{lcom}%
\end{document}
