...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 This specification is explained in ``Transaction \ensuremath{Commit}'',
 Lecture 5 of
...
\@y{\@s{0}%
 \ensuremath{rmState[rm]} is the state of resource manager \ensuremath{rm}.
}%
\@xx{}%
\@x{}\midbar\@xx{}%
\@x{ TCTypeOK \.{\defeq}}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 07 20:18:33 \ensuremath{CST} 2022 by \ensuremath{wengjialin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Tue} \ensuremath{Jun} 07
 20:15:47 \ensuremath{CST} 2022 by \ensuremath{wengjialin
}%
\end{cpar}%
\end{lcom}%
\end{document}
