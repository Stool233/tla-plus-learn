...
Spec == Init /\ [] [Next]_<<clientState, lockLeaseState, clientHeldLockState>>
...
Consistent3 == 
     \A c \in Client: ~(/\ clientState[c] = "ReleasingLock" 
                       /\ ~lockClientRef = c)
    

THEOREM Spec => [](TypeOK /\ Consistent /\ Consistent2)

=============================================================================
\* Modification History
\* Last modified Tue Jul 19 22:34:55 CST 2022 by wengjialin
