...
variables
    ...
    \* db_value is no longer global.  db_value \in Data;
...
\* BEGIN TRANSLATION (chksum(pcal) = "14edd522" /\ chksum(tla) = "eba4d6a")
...
\* Last modified Tue Oct 18 23:54:39 CST 2022 by wengjialin
