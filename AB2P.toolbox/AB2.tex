...
\@x{}\moduleLeftDash\@xx{ {\MODULE} AB2}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 This is a modification of spec \ensuremath{AB} in which instead of losing
 messages,
 messages are detectably ``corrupted''--represented by being changed to
 the value \ensuremath{Bad}. The to communication channels are represented by
 the
 variables \ensuremath{AtoB2} and \ensuremath{BtoA2}.
\end{cpar}%
\end{lcom}%
...
\@pvspace{8.0pt}%
\@x{ {\CONSTANT} Data ,\, Bad}%
 \@x{ {\ASSUME} Bad \.{\notin} ( Data \.{\times} \{ 0 ,\, 1 \} ) \.{\cup} \{ 0
 ,\, 1 \}}%
\@x{\@s{8.2}}%
\@y{\@s{0}%
 We need to asssume that \ensuremath{Bad} is different from any of the legal
}%
\@xx{}%
\@x{\@s{8.2}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{ {\VARIABLES} AVar ,\, BVar ,\,\@s{8.2}}%
\@y{\@s{0}%
 The same as in module \ensuremath{ABSpec
}}%
\@xx{}%
\@x{\@s{51.42} AtoB2 ,\,}%
\@y{\@s{0}%
 The sequence of data messages in transit from sender to receiver
}%
\@xx{}%
\@x{\@s{51.42} BtoA2\@s{6.88}}%
\@y{\@s{0}%
 The sequence of ack messages in transit from receiver to sender
}%
\@xx{}%
\@x{\@s{86.20}}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
\@x{ vars \.{\defeq} {\langle} AVar ,\, BVar ,\, AtoB2 ,\, BtoA2 {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ TypeOK \.{\defeq} \.{\land} AVar\@s{5.19} \.{\in} Data \.{\times} \{ 0
 ,\, 1 \}}%
\@x{\@s{56.14} \.{\land} BVar\@s{4.56} \.{\in} Data \.{\times} \{ 0 ,\, 1 \}}%
 \@x{\@s{56.14} \.{\land} AtoB2 \.{\in} Seq ( ( Data \.{\times} \{ 0 ,\, 1 \}
 ) \.{\cup} \{ Bad \} )}%
 \@x{\@s{56.14} \.{\land} BtoA2\@s{0.77} \.{\in} Seq ( \{ 0 ,\, 1 ,\, Bad \}
 )}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq} \.{\land} AVar\@s{5.19} \.{\in} Data \.{\times} \{ 1 \}}%
\@x{\@s{35.70} \.{\land} BVar\@s{4.56} \.{=} AVar}%
\@x{\@s{35.70} \.{\land} AtoB2 \.{=} {\langle} {\rangle}}%
\@x{\@s{35.70} \.{\land} BtoA2\@s{0.77} \.{=} {\langle} {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 The action of the sender sending a data message by appending
 \ensuremath{AVar} to
 the end of the message queue \ensuremath{AtoB2}. It will keep sending the
 same
 message until it receives an acknowledgment for it from the receiver.
\end{cpar}%
\end{lcom}%
\@x{ ASnd \.{\defeq} \.{\land} AtoB2 \.{'} \.{=} Append ( AtoB2 ,\, AVar )}%
 \@x{\@s{43.71} \.{\land} {\UNCHANGED} {\langle} AVar ,\, BtoA2 ,\, BVar
 {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
The action of the sender receiving an ack message. If that ack is for
 ...
 sets \ensuremath{AVar} to that message. If the ack is for the previous value
 it
 sent, it ignores the message. In either case, it removes the message
 from \ensuremath{BtoA2}. Note that \ensuremath{Bad} cannot equal
 \ensuremath{AVar[2]}, which is in \ensuremath{\{0,\,1\}}.
\end{cpar}%
\end{lcom}%
\@x{ ARcv \.{\defeq} \.{\land} BtoA2 \.{\neq} {\langle} {\rangle}}%
\@x{\@s{43.38} \.{\land} {\IF} Head ( BtoA2 ) \.{=} AVar [ 2 ]}%
 \@x{\@s{62.69} \.{\THEN} \E\, d \.{\in} Data \.{:} AVar \.{'} \.{=} {\langle}
 d ,\, 1 \.{-} AVar [ 2 ] {\rangle}}%
\@x{\@s{62.69} \.{\ELSE} AVar \.{'} \.{=} AVar}%
\@x{\@s{43.38} \.{\land} BtoA2 \.{'} \.{=} Tail ( BtoA2 )}%
\@x{\@s{43.38} \.{\land} {\UNCHANGED} {\langle} AtoB2 ,\, BVar {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{ BSnd \.{\defeq} \.{\land} BtoA2 \.{'} \.{=} Append ( BtoA2 ,\, BVar [ 2
 ] )}%
 \@x{\@s{43.31} \.{\land} {\UNCHANGED} {\langle} AVar ,\, BVar ,\, AtoB2
 {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 The action of the receiver receiving a data message. It ignores a
 \ensuremath{Bad
 } message. Otherwise, it sets \ensuremath{BVar} to the message if it\mbox{'}s
 not for the
 data item it has already received.
\end{cpar}%
\end{lcom}%
\@x{ BRcv \.{\defeq} \.{\land} AtoB2 \.{\neq} {\langle} {\rangle}}%
 \@x{\@s{42.98} \.{\land} {\IF} ( Head ( AtoB2 ) \.{\neq} Bad ) \.{\land} (
 Head ( AtoB2 ) [ 2 ] \.{\neq} BVar [ 2 ] )}%
\@x{\@s{62.29} \.{\THEN} BVar \.{'} \.{=} Head ( AtoB2 )}%
\@x{\@s{62.29} \.{\ELSE} BVar \.{'} \.{=} BVar}%
\@x{\@s{42.98} \.{\land} AtoB2 \.{'} \.{=} Tail ( AtoB2 )}%
\@x{\@s{42.98} \.{\land} {\UNCHANGED} {\langle} AVar ,\, BtoA2 {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{CorruptMsg} is the action that changes an arbitrary message in
 \ensuremath{AtoB2} or
 \ensuremath{BtoA2} to \ensuremath{Bad}. (We don\mbox{'}t bother testing if
 the message in \ensuremath{AtoB2} already
 equals \ensuremath{Bad}, since setting to \ensuremath{Bad} a message that
 already equals \ensuremath{Bad} is
 just a stuttering step.)
\end{cpar}%
\end{lcom}%
 \@x{ CorruptMsg \.{\defeq} \.{\land} \.{\lor} \.{\land} \E\, i \.{\in} 1
 \.{\dotdot} Len ( AtoB2 ) \.{:}}%
 \@x{\@s{113.46} AtoB2 \.{'} \.{=} [ AtoB2 {\EXCEPT} {\bang} [ i ] \.{=} Bad
 ]}%
\@x{\@s{94.15} \.{\land} BtoA2 \.{'} \.{=} BtoA2}%
 \@x{\@s{83.03} \.{\lor} \.{\land} \E\, i \.{\in} 1 \.{\dotdot} Len ( BtoA2 )
 \.{:}}%
 \@x{\@s{113.46} BtoA2 \.{'} \.{=} [ BtoA2 {\EXCEPT} {\bang} [ i ] \.{=} Bad
 ]}%
\@x{\@s{94.15} \.{\land} AtoB2 \.{'} \.{=} AtoB2}%
\@x{\@s{71.92} \.{\land} {\UNCHANGED} {\langle} AVar ,\, BVar {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ Next \.{\defeq} ASnd \.{\lor} ARcv \.{\lor} BSnd \.{\lor} BRcv \.{\lor}
 CorruptMsg}%
\@pvspace{8.0pt}%
\@x{ Spec\@s{1.46} \.{\defeq} Init \.{\land} {\Box} [ Next ]_{ vars}}%
\@x{}\midbar\@xx{}%
\@x{ ABS \.{\defeq} {\INSTANCE} ABSpec}%
\@pvspace{8.0pt}%
\@x{ {\THEOREM} Spec \.{\implies} ABS {\bang} Spec}%
\@x{}\midbar\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{FairSpec} is the analogue of formula \ensuremath{FairSpec} of
 module \ensuremath{AB2}. That is,
 it is obtained by conjoining to formula \ensuremath{Spec} the fairness
 conditions
 that correspond to the ones in module \ensuremath{AB2}. However,
 specification
 \ensuremath{FairSpec} of this module does not implement
 \ensuremath{ABS{\bang}FairSpec}. You can use
 \ensuremath{TLC} to find a behavior in which no new values are ever sent.
\end{cpar}%
\end{lcom}%
\@x{ FairSpec \.{\defeq}}%
 \@x{\@s{8.2} Spec \.{\land} {\SF}_{ vars} ( ARcv ) \.{\land} {\SF}_{ vars} (
 BRcv ) \.{\land} {\WF}_{ vars} ( ASnd ) \.{\land} {\WF}_{ vars} ( BSnd )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
A little thought reveals that, since messages are corrupted but not
 deleted, strong fairness of \ensuremath{ARcv} and \ensuremath{BRcv} is
 equivalent to weak
 fairness of those actions. The shortest counterexample showing that
 \ensuremath{FairSpec} does not implement \ensuremath{ABS{\bang}FairSpec},
 which is probably the one
 found by \ensuremath{TLC}, is a behavior in which a message is sent on an
 empty
 message channel, but is always corrupted before it can received. This
 suggests that in addition to weak fairness of \ensuremath{ARcv} and
 \ensuremath{BRcv}, we want
 strong fairness of those actions when the head of the queue is not
 corrupt. That leads to the following spec.
\end{cpar}%
\end{lcom}%
\@x{ FairSpec2 \.{\defeq}}%
 \@x{\@s{8.2} Spec \.{\land} {\WF}_{ vars} ( ARcv ) \.{\land} {\WF}_{ vars} (
 BRcv ) \.{\land} {\WF}_{ vars} ( ASnd ) \.{\land} {\WF}_{ vars} ( BSnd )}%
 \@x{\@s{27.67} \.{\land} {\SF}_{ vars} ( ARcv \.{\land} Head ( BtoA2
 )\@s{0.77} \.{\neq} Bad )}%
 \@x{\@s{27.67} \.{\land} {\SF}_{ vars} ( BRcv\@s{0.39} \.{\land} Head ( AtoB2
 ) \.{\neq} Bad )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 Running \ensuremath{TLC} shows that \ensuremath{FairSpec2} also does not
 implement \ensuremath{ABS{\bang}FairSpec}.
 In fact, I believe that it is impossible to obtain a specification that
 implements \ensuremath{ABS{\bang}FairSpec} by conjoining to
 \ensuremath{Spec} fairness conditions on
 subactions of \ensuremath{Next}. Module \ensuremath{AB2P} shows how we can
 modify the \ensuremath{AB2
 } specification to obtain a specification that implements
 \ensuremath{ABS{\bang}Spec}.
\end{cpar}%
\end{lcom}%
\@x{}\midbar\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 We define \ensuremath{RemoveBad} so that \ensuremath{RemoveBad(seq)} is the
 value obtained by
 removing from the sequence \ensuremath{seq} all elements that equal
 \ensuremath{Bad}.
\end{cpar}%
\end{lcom}%
\@x{ {\RECURSIVE} RemoveBad ( \_ )}%
\@x{ RemoveBad ( seq ) \.{\defeq}}%
\@x{\@s{8.2} {\IF} seq \.{=} {\langle} {\rangle}}%
\@x{\@s{16.4} \.{\THEN} {\langle} {\rangle}}%
 \@x{\@s{16.4} \.{\ELSE} ( {\IF} Head ( seq ) \.{=} Bad \.{\THEN} {\langle}
 {\rangle} \.{\ELSE} {\langle} Head ( seq ) {\rangle} )}%
\@x{\@s{55.69} \.{\circ} RemoveBad ( Tail ( seq ) )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 There\mbox{'}s an easy way to define \ensuremath{RemoveBad} using the
 \ensuremath{SelectSeq} operator of
 the \ensuremath{Sequences} module. Here\mbox{'}s the alternative definition.
\end{cpar}%
\end{lcom}%
 \@x{ RemoveBadAlt ( seq ) \.{\defeq} \.{\LET} Test ( elt ) \.{\defeq} elt
 \.{\neq} Bad}%
\@x{\@s{105.46} \.{\IN} SelectSeq ( seq ,\, Test )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 The following statement defines \ensuremath{AB{\bang}Spec} to be the
 specification \ensuremath{Spec} of
 module \ensuremath{AB} with \ensuremath{RemoveBad(AtoB2)} substituted for
 \ensuremath{AtoB} and
 \ensuremath{RemoveBad(BtoA2)} substituted for \ensuremath{BtoA}.
\end{cpar}%
\end{lcom}%
 \@x{ AB \.{\defeq} {\INSTANCE} AB {\WITH} AtoB \.{\leftarrow} RemoveBad (
 AtoB2 ) ,\, BtoA \.{\leftarrow} RemoveBad ( BtoA2 )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
The following theorem asserts that the specification \ensuremath{Spec} of this
 module implements the specification \ensuremath{Spec} of module
 \ensuremath{AB} under the
 refinement mapping that substitutes \ensuremath{RemoveBad(AtoB2)} for
 \ensuremath{AtoB} and
 substitutes for every other variable and every constant of module
 \ensuremath{AB
} the variable or constant of the same name. This theorem is checked by
 having \ensuremath{TLC} check that the temporal property
 \ensuremath{AB{\bang}Spec} is satisfied by the
 specification \ensuremath{Spec}.
\end{cpar}%
\end{lcom}%
\@x{ {\THEOREM} Spec \.{\implies} AB {\bang} Spec}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 21:33:05 \ensuremath{CST} 2022 by \ensuremath{wengjialin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Wed}
 \ensuremath{Jan} 24 16:33:07 \ensuremath{PST} 2018 by \ensuremath{lamport
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Wed} \ensuremath{Mar} 25
 11:53:40 \ensuremath{PDT} 2015 by \ensuremath{lamport
}%
\end{cpar}%
\end{lcom}%
\end{document}
