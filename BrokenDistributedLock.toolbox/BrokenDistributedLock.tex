...
\setboolean{shading}{true}
 ...
 BrokenDistributedLock}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\CONSTANT} Client}%
\@y{\@s{0}%
 The set of client
...
\@pvspace{8.0pt}%
\@x{ {\VARIABLES}}%
\@x{\@s{16.4} clientState ,\,}%
\@y{\@s{0}%
 \ensuremath{clientState[c]} is the state of client \ensuremath{c}.
}%
\@xx{}%
\@x{\@s{16.4} lockLeaseState}%
\@pvspace{16.0pt}%
\@x{ TypeOK \.{\defeq}}%
 \@x{\@s{16.4} \.{\land}\@s{9.74} clientState \.{\in} [ Client \.{\rightarrow}
 \{\@w{init} ,\,\@w{gotLockLease} ,\,\@w{WritingData} ,\,\@w{WroteData} \} ]}%
 \@x{\@s{16.4} \.{\land}\@s{9.74} lockLeaseState \.{\in} \{\@w{unlock}
 ,\,\@w{locked} \}}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
\begin{lcom}{16.4}%
...
\end{cpar}%
\end{lcom}%
 \@x{\@s{16.4} \.{\land} clientState \.{=} [ c \.{\in} Client
 \.{\mapsto}\@w{init} ]}%
\@x{\@s{16.4} \.{\land} lockLeaseState \.{=}\@w{unlock}}%
\@pvspace{8.0pt}%
\@x{ ClientLocking ( c ) \.{\defeq}}%
\begin{lcom}{16.4}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
客户端\ensuremath{c}占有共享资源对应的锁
\end{cpar}%
\end{lcom}%
\@x{\@s{16.4} \.{\land} lockLeaseState \.{=}\@w{unlock}}%
\@x{\@s{16.4} \.{\land} clientState [ c ]\@s{5.51} \.{=}\@w{init}}%
\@x{\@s{16.4} \.{\land} lockLeaseState \.{'} \.{=}\@w{locked}}%
 \@x{\@s{16.4} \.{\land} clientState \.{'} \.{=} [ clientState {\EXCEPT}
 {\bang} [ c ] \.{=}\@w{gotLockLease} ]}%
\@pvspace{8.0pt}%
\@x{ ClientWritingData ( c ) \.{\defeq}}%
\begin{lcom}{16.4}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
客户端\ensuremath{c}访问共享资源
\end{cpar}%
\end{lcom}%
\@x{\@s{16.4} \.{\land} clientState [ c ] \.{=}\@w{gotLockLease}}%
 \@x{\@s{16.4} \.{\land} clientState \.{'} \.{=} [ clientState {\EXCEPT}
 {\bang} [ c ] \.{=}\@w{WritingData} ]}%
\@pvspace{8.0pt}%
\@x{ ClientWroteData ( c ) \.{\defeq}}%
\begin{lcom}{16.4}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
客户端\ensuremath{c}访问共享资源完成并释放锁
\end{cpar}%
\end{lcom}%
\@x{\@s{16.4} \.{\land} clientState [ c ] \.{=}\@w{WritingData}}%
 \@x{\@s{16.4} \.{\land} clientState \.{'} \.{=} [ clientState {\EXCEPT}
 {\bang} [ c ] \.{=}\@w{WroteData} ]}%
\@x{\@s{16.4} \.{\land} lockLeaseState \.{'} \.{=}\@w{unlock}}%
\@pvspace{8.0pt}%
...
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq}}%
\@x{\@s{16.4} \.{\lor} LockExpire}%
\@x{\@s{16.4} \.{\lor} \E\, c \.{\in} Client \.{:}}%
 \@x{\@s{31.61} ClientLocking ( c ) \.{\lor} ClientWritingData ( c ) \.{\lor}
 ClientWroteData ( c )}%
\@pvspace{8.0pt}%
 \@x{ Spec \.{\defeq} Init \.{\land} {\Box} [ Next ]_{ {\langle} clientState
 ,\, lockLeaseState {\rangle}}}%
\@pvspace{16.0pt}%
\@x{ Consistent \.{\defeq}}%
 \@x{\@s{16.4} \A\, c \.{\in} Client \.{:} {\lnot} ( \.{\land} clientState [ c
 ] \.{=}\@w{WritingData}}%
\@x{\@s{88.49} \.{\land} {\lnot} lockLeaseState \.{=}\@w{locked} )}%
\@pvspace{8.0pt}%
\@x{ {\THEOREM} Spec \.{\implies} {\Box} ( TypeOK \.{\land} Consistent )}%
\@pvspace{24.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun \ensuremath{Jul} 17
 22:34:45 \ensuremath{CST} 2022 by \ensuremath{wengjialin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sun \ensuremath{Jul} 17 20:46:46
