...
\tlatex
 ...
 facebookcacheinvalidation2}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 将\ensuremath{invalidationQueue}改成有序队列
}%
\@xx{}%
\@pvspace{8.0pt}%
...
\@x{\@s{16.4}}%
\@y{\@s{0}%
 Represents the version stored in the cache, This is what is used for
 comparsions.
}%
\@xx{}%
\@x{\@s{16.4}}%
...
\@xx{}%
\@x{\@s{16.4} cacheVersions ,\,}%
\@x{\@s{16.4} cacheFillStates ,\,}%
\@x{\@s{16.4} invalidationQueue ,\,}%
\@x{\@s{16.4} counter}%
\@y{\@s{0}%
 Used to prevent repeated states for liveness conditions
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 We can still test with the same cache requirements we\mbox{'}ve been using
 this whole time
}%
\@xx{}%
\@x{ {\INSTANCE} cacherequirements}%
\@pvspace{8.0pt}%
\@x{ vars \.{\defeq} {\langle} database ,\, cache ,\, cacheFillStates ,\,}%
\@x{\@s{16.4} invalidationQueue ,\, counter ,\, cacheVersions {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ InvalidationMessage \.{\defeq} [ key \.{:} KEYS ,\, version \.{:}
 DataVersion ]}%
\@pvspace{8.0pt}%
\@x{ CacheFillState \.{\defeq} [}%
\@x{\@s{16.4} state \.{:} \{}%
\@x{\@s{32.8}\@w{inactive} ,\,}%
\@x{\@s{32.8}\@w{startfillmetadata} ,\,}%
\@x{\@s{32.8}\@w{respondedtometadata} ,\,}%
\@y{\@s{0}%
 Next: \ensuremath{CacheFillMetadata
}}%
\@xx{}%
\@x{\@s{32.8}\@w{startfillversion} ,\,}%
\@x{\@s{32.8}\@w{responedtoversion}}%
\@y{\@s{0}%
 Next: \ensuremath{CacheFillVersion
}}%
\@xx{}%
\@x{\@s{16.4} \} ,\,}%
\@x{\@s{16.4} version \.{:} DataVersion}%
\@x{ ]}%
\@pvspace{8.0pt}%
\@x{ CacheValue \.{\defeq} CacheMiss \.{\cup} CacheHit}%
\@pvspace{8.0pt}%
\@x{ TypeOk \.{\defeq}}%
 \@x{\@s{16.4} \.{\land}\@s{6.27} database \.{\in} [ KEYS \.{\rightarrow}
 DataVersion ]}%
 \@x{\@s{16.4} \.{\land}\@s{6.27} cache \.{\in} [ KEYS \.{\rightarrow}
 CacheValue ]}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\@s{16.4} \.{\land} cacheVersions \.{\in} [ KEYS \.{\rightarrow}
 CacheValue ]}%
 \@x{\@s{16.4} \.{\land} cacheFillStates \.{\in} [ KEYS \.{\rightarrow}
 CacheFillState ]}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
 保证下有序
...
\@xx{}%
 \@x{\@s{16.4} \.{\land} invalidationQueue \.{\in} Seq ( InvalidationMessage
 )}%
\@x{\@s{16.4} \.{\land} counter \.{\in} Nat}%
\@pvspace{16.0pt}%
\@x{ Init \.{\defeq}}%
\@x{\@s{16.4} \.{\land} database \.{=} [ k \.{\in} KEYS \.{\mapsto} 0 ]}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
 cache (metadata) and \ensuremath{cacheVersions} start empty together
}%
\@xx{}%
 \@x{\@s{16.4} \.{\land} cache \.{=} [ k \.{\in} KEYS \.{\mapsto} [ type
 \.{\mapsto}\@w{miss} ] ]}%
 \@x{\@s{16.4} \.{\land} cacheVersions \.{=} [ k \.{\in} KEYS \.{\mapsto} [
 type \.{\mapsto}\@w{miss} ] ]}%
\@pvspace{8.0pt}%
\@x{\@s{16.4} \.{\land} cacheFillStates \.{=} [ k \.{\in} KEYS \.{\mapsto} [}%
\@x{\@s{128.24} state \.{\mapsto}\@w{inactive} ,\,}%
\@x{\@s{128.24} version \.{\mapsto} 0}%
\@x{\@s{128.24} ]}%
\@x{\@s{106.45} ]}%
\@x{\@s{16.4} \.{\land} invalidationQueue \.{=} {\langle} {\rangle}}%
\@x{\@s{16.4} \.{\land} counter \.{=} 0}%
\@pvspace{16.0pt}%
\@x{ DatabaseUpdate ( k ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\LET} updatedVersion \.{\defeq} database [ k ] \.{+} 1
 \.{\IN}}%
\@x{\@s{16.4} \.{\land} database \.{'} \.{=} [ database {\EXCEPT}}%
\@x{\@s{83.72} {\bang} [ k ] \.{=} updatedVersion ]}%
 \@x{\@s{16.4} \.{\land} invalidationQueue \.{'} \.{=} Append (
 invalidationQueue ,\,}%
 \@x{\@s{139.76} [ key \.{\mapsto} k ,\, version \.{\mapsto} updatedVersion ]
 )}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} cache ,\, cacheVersions ,\,
 cacheFillStates ,\, counter {\rangle}}%
\@pvspace{16.0pt}%
\@x{ CacheStartFillMetadata ( k ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} cache [ k ] \.{\in} CacheMiss}%
\@x{\@s{16.4} \.{\land} cacheFillStates [ k ] . state \.{=}\@w{inactive}}%
 \@x{\@s{16.4} \.{\land} cacheFillStates \.{'} \.{=} [ cacheFillStates
 {\EXCEPT} {\bang} [ k ] . state \.{=}\@w{startfillmetadata} ]}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} database ,\, cache ,\,
 cacheVersions ,\, invalidationQueue ,\, counter {\rangle}}%
\@pvspace{16.0pt}%
\@x{ DatabaseRespondWithMetadata ( k ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} cacheFillStates [ k ] . state
 \.{=}\@w{startfillmetadata}}%
 \@x{\@s{16.4} \.{\land} cacheFillStates \.{'} \.{=} [ cacheFillStates
 {\EXCEPT}}%
\@x{\@s{132.54} {\bang} [ k ] . state \.{=}\@w{respondedtometadata} ,\,}%
\@x{\@s{132.54} {\bang} [ k ] . version \.{=} database [ k ] ]}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} database ,\, cache ,\,
 cacheVersions ,\, invalidationQueue ,\, counter {\rangle}}%
\@pvspace{16.0pt}%
\@x{ CacheFillMetadata ( k ) \.{\defeq}}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\@s{16.4} \.{\land} cacheFillStates [ k ] . state
 \.{=}\@w{respondedtometadata}}%
\@x{\@s{16.4} \.{\land} cache \.{'} \.{=} [ cache {\EXCEPT}}%
\@x{\@s{115.45} {\bang} [ k ] \.{=} [}%
\@x{\@s{132.57} type \.{\mapsto}\@w{hit} ,\,}%
\@x{\@s{132.57} version \.{\mapsto} cacheFillStates [ k ] . version}%
\@x{\@s{115.45} ]}%
\@x{\@s{67.91} ]}%
 \@x{\@s{16.4} \.{\land} cacheFillStates \.{'} \.{=} [ cacheFillStates
 {\EXCEPT}}%
\@x{\@s{132.54} {\bang} [ k ] . state \.{=}\@w{inactive} ,\,}%
\@x{\@s{132.54} {\bang} [ k ] . version \.{=} 0 ]}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} database ,\, cacheVersions ,\,
 invalidationQueue ,\, counter {\rangle}}%
\@pvspace{16.0pt}%
\@x{ CacheStartFillVersion ( k ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} cacheVersions [ k ] \.{\in} CacheMiss}%
\@x{\@s{16.4} \.{\land} cacheFillStates [ k ] . state \.{=}\@w{inactive}}%
 \@x{\@s{16.4} \.{\land} cacheFillStates \.{'} \.{=} [ cacheFillStates
 {\EXCEPT} {\bang} [ k ] . state \.{=}\@w{startfillversion} ]}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} database ,\, cache ,\,
 cacheVersions ,\, invalidationQueue ,\, counter {\rangle}}%
\@pvspace{16.0pt}%
\@x{ DatabaseRespondWithVersion ( k ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} cacheFillStates [ k ] . state
 \.{=}\@w{startfillversion}}%
 \@x{\@s{16.4} \.{\land} cacheFillStates \.{'} \.{=} [ cacheFillStates
 {\EXCEPT}}%
\@x{\@s{132.54} {\bang} [ k ] . state \.{=}\@w{responedtoversion} ,\,}%
\@x{\@s{132.54} {\bang} [ k ] . version \.{=} database [ k ] ]}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} database ,\, cache ,\,
 cacheVersions ,\, invalidationQueue ,\, counter {\rangle}}%
\@pvspace{16.0pt}%
\@x{ CacheFillVersion ( k ) \.{\defeq}}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\@s{16.4} \.{\land} cacheFillStates [ k ] . state
 \.{=}\@w{responedtoversion}}%
\@x{\@s{16.4} \.{\land} \.{\lor} cacheVersions [ k ] \.{\in} CacheMiss}%
\@x{\@s{27.51} \.{\lor} \.{\land} cacheVersions [ k ] \.{\notin} CacheMiss}%
 \@x{\@s{38.62} \.{\land} cacheVersions [ k ] . version \.{<} cacheFillStates
 [ k ] . version}%
\@x{\@s{16.4} \.{\land} cacheVersions \.{'} \.{=} [ cacheVersions {\EXCEPT}}%
\@x{\@s{120.52} {\bang} [ k ] \.{=} [}%
\@x{\@s{137.64} type \.{\mapsto}\@w{hit} ,\,}%
\@x{\@s{137.64} version \.{\mapsto} cacheFillStates [ k ] . version}%
\@x{\@s{120.52} ]}%
\@x{\@s{64.41} ]}%
 \@x{\@s{16.4} \.{\land} cacheFillStates \.{'} \.{=} [ cacheFillStates
 {\EXCEPT}}%
...
\@x{\@s{132.54} {\bang} [ k ] . version \.{=} 0 ]}%
 ...
 invalidationQueue ,\, counter {\rangle}}%
\@pvspace{16.0pt}%
\@x{ CacheIgnoreFillVersion ( k ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} cacheFillStates [ k ] . state
 \.{=}\@w{responedtoversion}}%
\@x{\@s{16.4} \.{\land} \.{\land} cacheVersions [ k ] \.{\in} CacheHit}%
 \@x{\@s{27.51} \.{\land} cacheVersions [ k ] . version \.{\geq}
 cacheFillStates [ k ] . version}%
 \@x{\@s{16.4} \.{\land} cacheFillStates \.{'} \.{=} [ cacheFillStates
 {\EXCEPT}}%
\@x{\@s{132.54} {\bang} [ k ] . state \.{=}\@w{inactive} ,\,}%
\@x{\@s{132.54} {\bang} [ k ] . version \.{=} 0 ]}%
...
\@xx{}%
\@x{\@s{16.4} \.{\land} counter \.{'} \.{=} counter \.{+} 1}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} database ,\, cache ,\,
 cacheVersions ,\, invalidationQueue {\rangle}}%
\@pvspace{16.0pt}%
\@x{ CacheFailFill ( k ) \.{\defeq}}%
 \@x{\@s{16.4} \.{\land} cacheFillStates [ k ] . state \.{\in}\@s{4.1}
 \{\@w{respondedtometadata} ,\,\@w{responedtoversion} \}}%
 \@x{\@s{16.4} \.{\land} cacheFillStates \.{'} \.{=} [ cacheFillStates
 {\EXCEPT}}%
\@x{\@s{132.54} {\bang} [ k ] . state \.{=}\@w{inactive} ,\,}%
\@x{\@s{132.54} {\bang} [ k ] . version \.{=} 0 ]}%
...
\@xx{}%
\@x{ CacheEvict ( k ) \.{\defeq}}%
\@x{\@s{16.4} \.{\land} cache [ k ] \.{\in} CacheHit}%
\@x{\@s{16.4} \.{\land} cacheFillStates [ k ] . state \.{=}\@w{inactive}}%
 \@x{\@s{16.4} \.{\land} cache \.{'} \.{=} [ cache {\EXCEPT} {\bang} [ k ]
 \.{=} [ type \.{\mapsto}\@w{miss} ] ]}%
 \@x{\@s{16.4} \.{\land} cacheVersions \.{'} \.{=} [ cache {\EXCEPT}\@s{4.1}
 {\bang} [ k ] \.{=} [ type \.{\mapsto}\@w{miss} ] ]}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
 防止活性重复状态
}%
\@xx{}%
\@x{\@s{16.4} \.{\land} counter \.{'} \.{=} counter \.{+} 1}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} database ,\, cacheFillStates
 ,\, invalidationQueue {\rangle}}%
\@pvspace{16.0pt}%
\@x{ UpdateFromInvalidationMessage \.{\defeq}}%
\@x{\@s{16.4} \.{\land} invalidationQueue \.{\neq} {\langle} {\rangle}}%
 \@x{\@s{16.4} \.{\land} \.{\LET} message \.{\defeq} Head ( invalidationQueue
 ) \.{\IN}}%
\@x{\@s{47.91}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\@s{31.61} \.{\land}\@s{5.18} \.{\lor} \.{\land} cache [ message . key ]
 \.{\in} CacheHit}%
\@x{\@s{59.02} \.{\land} cacheVersions [ message . key ] \.{\in} CacheMiss}%
\@x{\@s{47.91}}%
\@y{\@s{0}%
 版本处理
}%
\@xx{}%
 \@x{\@s{47.91} \.{\lor} \.{\land} cacheVersions [ message . key ] \.{\in}
 CacheHit}%
 \@x{\@s{59.02} \.{\land} cacheVersions [ message . key ] . version \.{\leq}
 message . version}%
\@pvspace{8.0pt}%
\@x{\@s{31.61}}%
\@y{\@s{0}%
...
\@xx{}%
 \@x{\@s{31.61} \.{\land} cacheFillStates [ message . key ] . state
 \.{=}\@w{inactive}}%
\@pvspace{8.0pt}%
\@x{\@s{31.61}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\@s{31.61} \.{\land} cache \.{'} \.{=} [ cache {\EXCEPT}}%
\@x{\@s{114.26} {\bang} [ message . key ] \.{=} [}%
\@x{\@s{146.21} type \.{\mapsto}\@w{hit} ,\,}%
\@x{\@s{146.21} version \.{\mapsto} message . version}%
\@x{\@s{114.26} ]}%
\@x{\@s{83.12} ]}%
\@x{\@s{31.61} \.{\land} cacheVersions \.{'} \.{=} [ cacheVersions {\EXCEPT}}%
\@x{\@s{152.13} {\bang} [ message . key ] \.{=} [}%
\@x{\@s{184.07} type \.{\mapsto}\@w{hit} ,\,}%
\@x{\@s{184.07} version \.{\mapsto} message . version}%
\@x{\@s{152.13} ]}%
\@x{\@s{120.65} ]}%
 \@x{\@s{31.61} \.{\land} invalidationQueue \.{'} \.{=} Tail (
 invalidationQueue )}%
\@pvspace{8.0pt}%
 \@x{\@s{31.61} \.{\land} {\UNCHANGED} {\langle} database ,\, cacheFillStates
 ,\, counter {\rangle}}%
\@pvspace{8.0pt}%
\@x{ IgnoreInvalidationMessage \.{\defeq}}%
\@x{\@s{16.4} \.{\land} invalidationQueue \.{\neq} {\langle} {\rangle}}%
 \@x{\@s{16.4} \.{\land} \.{\LET} message \.{\defeq} Head ( invalidationQueue
 ) \.{\IN}}%
\@x{\@s{47.91}}%
...
\@xx{}%
 \@x{\@s{31.61} \.{\land}\@s{5.18} \.{\lor} \.{\land} cache [ message . key ]
 \.{\in} CacheMiss}%
 \@x{\@s{59.02} \.{\land} cacheFillStates [ message . key ] . state
 \.{=}\@w{inactive}}%
\@x{\@s{47.91}}%
\@y{\@s{0}%
 缓存已经有了更大的版本
...
\@xx{}%
 \@x{\@s{47.91} \.{\lor} \.{\land} cacheVersions [ message . key ] \.{\in}
 CacheHit}%
 \@x{\@s{59.02} \.{\land} cacheVersions [ message . key ] . version \.{>}
 message . version}%
 \@x{\@s{31.61} \.{\land}\@s{5.18} invalidationQueue \.{'} \.{=} Tail (
 invalidationQueue )}%
\@x{\@s{31.61}}%
\@y{\@s{0}%
 防止活性重复状态
...
\@xx{}%
\@x{\@s{31.61} \.{\land} counter \.{'} \.{=} counter \.{+} 1}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} database ,\, cache ,\,
 cacheVersions ,\, cacheFillStates {\rangle}}%
\@pvspace{24.0pt}%
\@x{}%
\@y{\@s{0}%
 \ensuremath{FailUpdateInvalidationMessageIgnore \.{\defeq}
}}%
\@xx{}%
\@x{}%
\@y{\@s{10.0}%
 \ensuremath{\.{\land} invalidationQueue \.{\neq} {\langle} {\rangle}
}}%
\@xx{}%
\@x{}%
\@y{\@s{10.0}%
 \ensuremath{\.{\land} \.{\LET} message \.{\defeq} Head(invalidationQueue)
 \.{\IN}
}}%
\@xx{}%
\@x{}%
\@y{\@s{20.0}%
 \ensuremath{\.{\,\backslash\,}}* 在缓存中的version 大于等于 事件中的version时会忽略异常处理程序的处理
}%
\@xx{}%
\@x{}%
\@y{\@s{20.0}%
 \ensuremath{\.{\land} cacheVersions[message.key] \.{\in} CacheHit
}}%
\@xx{}%
\@x{}%
\@y{\@s{20.0}%
 \ensuremath{\.{\land} cacheVersions[message.key].version \.{\geq}
 message.version
}}%
\@xx{}%
\@x{}%
\@y{\@s{20.0}%
 \ensuremath{\.{\land} invalidationQueue\.{'} \.{=} Tail(invalidationQueue)
}}%
\@xx{}%
\@x{}%
\@y{\@s{20.0}%
 \ensuremath{\.{\,\backslash\,}}* 防止活性重复状态
}%
\@xx{}%
\@x{}%
\@y{\@s{20.0}%
 \ensuremath{\.{\land} counter\.{'} \.{=} counter \.{+} 1
}}%
\@xx{}%
\@x{}%
\@y{\@s{10.0}%
 \ensuremath{\.{\land} {\UNCHANGED} {\langle}database,\, cache,\,
 cacheVersions,\, cacheFillStates{\rangle}
}}%
\@xx{}%
\@pvspace{8.0pt}%
...
\@xx{}%
\@x{ FailUpdateInvalidationMessageIgnore \.{\defeq}}%
\@x{\@s{16.4} \.{\land} invalidationQueue \.{\neq} {\langle} {\rangle}}%
 \@x{\@s{16.4} \.{\land} \.{\LET} message \.{\defeq} Head ( invalidationQueue
 ) \.{\IN}}%
\@x{\@s{31.61}}%
...
\@xx{}%
\@x{\@s{31.61} \.{\land} cacheVersions [ message . key ] \.{\in} CacheHit}%
 \@x{\@s{31.61} \.{\land} cacheVersions [ message . key ] . version \.{>}
 message . version}%
 \@x{\@s{31.61} \.{\land} invalidationQueue \.{'} \.{=} Tail (
 invalidationQueue )}%
\@x{\@s{31.61}}%
...
\@xx{}%
\@x{\@s{31.61} \.{\land} counter \.{'} \.{=} counter \.{+} 1}%
 \@x{\@s{31.61} \.{\land} {\UNCHANGED} {\langle} database ,\, cache ,\,
 cacheVersions ,\, cacheFillStates {\rangle}}%
\@pvspace{16.0pt}%
\@x{ FailUpdateInvalidationMessageEvictkey \.{\defeq}}%
\@x{\@s{16.4} \.{\land} invalidationQueue \.{\neq} {\langle} {\rangle}}%
 \@x{\@s{16.4} \.{\land} \.{\LET} message \.{\defeq} Head ( invalidationQueue
 ) \.{\IN}}%
\@x{\@s{47.91}}%
...
\@pvspace{8.0pt}%
 \@x{\@s{31.61} \.{\land} invalidationQueue \.{'} \.{=} Tail (
 invalidationQueue )}%
 \@x{\@s{31.61} \.{\land} cache \.{'} \.{=} [ cache {\EXCEPT} {\bang} [
 message . key ] \.{=} [ type \.{\mapsto}\@w{miss} ] ]}%
 \@x{\@s{31.61} \.{\land} cacheVersions \.{'} \.{=} [ cacheVersions {\EXCEPT}
 {\bang} [ message . key ] \.{=} [ type \.{\mapsto}\@w{miss} ] ]}%
 \@x{\@s{16.4} \.{\land} {\UNCHANGED} {\langle} database ,\, cacheFillStates
 ,\, counter {\rangle}}%
\@pvspace{24.0pt}%
\@x{ CacheFairness \.{\defeq}}%
\@x{\@s{16.4} \.{\lor} \E\, k \.{\in} KEYS \.{:}}%
\@x{\@s{31.61} \.{\lor} CacheStartFillMetadata ( k )}%
\@x{\@s{31.61} \.{\lor} DatabaseRespondWithMetadata ( k )}%
\@x{\@s{31.61} \.{\lor} CacheFillMetadata ( k )}%
\@x{\@s{31.61} \.{\lor} CacheStartFillVersion ( k )}%
\@x{\@s{31.61} \.{\lor} DatabaseRespondWithVersion ( k )}%
\@x{\@s{31.61} \.{\lor} CacheFillVersion ( k )}%
\@x{\@s{31.61} \.{\lor} CacheIgnoreFillVersion ( k )}%
\@x{\@s{16.4} \.{\lor} UpdateFromInvalidationMessage}%
\@x{\@s{16.4} \.{\lor} IgnoreInvalidationMessage}%
\@x{\@s{16.4} \.{\lor} FailUpdateInvalidationMessageIgnore}%
\@x{\@s{16.4} \.{\lor} FailUpdateInvalidationMessageEvictkey}%
\@pvspace{16.0pt}%
\@x{ Next \.{\defeq}}%
\@x{\@s{16.4} \.{\lor} \E\, k \.{\in} KEYS \.{:}}%
\@x{\@s{31.61}}%
...
\@xx{}%
\@x{\@s{31.61} \.{\lor} DatabaseUpdate ( k )}%
\@x{\@s{31.61}}%
\@y{\@s{0}%
 Cache state
}%
...
\@x{\@s{31.61} \.{\lor} CacheFillVersion ( k )}%
\@x{\@s{31.61} \.{\lor} CacheIgnoreFillVersion ( k )}%
\@x{\@s{31.61} \.{\lor} CacheFailFill ( k )}%
\@x{\@s{31.61} \.{\lor} CacheEvict ( k )}%
\@x{\@s{16.4} \.{\lor} UpdateFromInvalidationMessage}%
\@x{\@s{16.4} \.{\lor} IgnoreInvalidationMessage}%
\@x{\@s{16.4} \.{\lor} FailUpdateInvalidationMessageIgnore}%
\@x{\@s{16.4} \.{\lor} FailUpdateInvalidationMessageEvictkey}%
...
\@xx{}%
\@x{ CounterBound \.{\defeq} counter \.{\leq} 2}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\end{document}
