...
\@x{}\moduleLeftDash\@xx{ {\MODULE} AB2H}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 This is spec \ensuremath{AB2} with history variables \ensuremath{AtoB} and
 \ensuremath{BtoA} added so the spec
 implements spec \ensuremath{AB} under the identity refinement mapping.
\end{cpar}%
\end{lcom}%
...
\@xx{}%
\@pvspace{8.0pt}%
\@x{ AB2 \.{\defeq} {\INSTANCE} AB2}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 We define \ensuremath{RemoveBad} so that \ensuremath{RemoveBad(seq)} removes
 from the sequence
 \ensuremath{seq} all elements that equal \ensuremath{Bad}.
\end{cpar}%
\end{lcom}%
\@x{ {\RECURSIVE} RemoveBad ( \_ )}%
\@x{\@s{8.2} RemoveBad ( seq ) \.{\defeq}}%
 \@x{\@s{8.2} {\IF} seq \.{=} {\langle} {\rangle} \.{\THEN} {\langle}
 {\rangle}}%
 \@x{\@s{55.12} \.{\ELSE} ( {\IF} Head ( seq ) \.{=} Bad \.{\THEN} {\langle}
 {\rangle} \.{\ELSE} {\langle} Head ( seq ) {\rangle} )}%
\@x{\@s{86.43} \.{\circ} RemoveBad ( Tail ( seq ) )}%
\@pvspace{8.0pt}%
\@x{ {\RECURSIVE} RemoveBad2 ( \_ )}%
\@x{ RemoveBad2 ( seq ) \.{\defeq}}%
 \@x{\@s{8.2} {\IF} seq \.{=} {\langle} {\rangle} \.{\THEN} {\langle}
 {\rangle}}%
\@x{\@s{55.12} \.{\ELSE} {\IF} Head ( seq ) \.{=} Bad}%
\@x{\@s{94.63} \.{\THEN} RemoveBad ( Tail ( seq ) )}%
 \@x{\@s{94.63} \.{\ELSE} {\langle} Head ( seq ) {\rangle} \.{\circ} RemoveBad
 ( Tail ( seq ) )}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES} AtoB ,\, BtoA}%
\@y{\@s{0}%
 Note that TLA+ allows multiple \ensuremath{{\VARIABLE}} statements.
}%
\@xx{}%
\@pvspace{16.0pt}%
\@x{ SpecH \.{\defeq} \.{\land} AB2 {\bang} Spec}%
\@x{\@s{46.87} \.{\land} {\Box} \.{\land} AtoB \.{=} RemoveBad ( AtoB2 )}%
\@x{\@s{65.45} \.{\land} BtoA\@s{0.77} \.{=} RemoveBad ( BtoA2 )}%
\@pvspace{8.0pt}%
\@x{ AB \.{\defeq} {\INSTANCE} AB}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 The following theorem asserts that \ensuremath{SpecH} implements/refines the
 \ensuremath{AB
 } protocol. However, it can\mbox{'}t be checked by \ensuremath{TLC} because
 it doesn\mbox{'}t have
 the form \ensuremath{TLC} requires of a specification.
\end{cpar}%
\end{lcom}%
\@x{ {\THEOREM} SpecH \.{\implies} AB {\bang} Spec}%
\@x{}\midbar\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 We now define \ensuremath{SpecHH} to be a specification that is equivalent to
 \ensuremath{SpecH
 } and that \ensuremath{TLC} can check. We write the definition of
 \ensuremath{SpecHH} in a way
 that should makes it clear that \ensuremath{SpecHH} is equivalent to
 \ensuremath{SpecH}.
\end{cpar}%
\end{lcom}%
\@x{ TypeOKH \.{\defeq} \.{\land} AB2 {\bang} TypeOK}%
\@x{\@s{63.76} \.{\land} AtoB \.{\in} Seq ( Data \.{\times} \{ 0 ,\, 1 \} )}%
\@x{\@s{63.76} \.{\land} BtoA\@s{0.77} \.{\in} Seq ( \{ 0 ,\, 1 \} )}%
\@pvspace{8.0pt}%
\@x{ InitH\@s{4.12} \.{\defeq} \.{\land} AB2 {\bang} Init}%
\@x{\@s{47.95} \.{\land} AtoB \.{=} RemoveBad ( AtoB2 )}%
\@x{\@s{47.95} \.{\land} BtoA\@s{0.77} \.{=} RemoveBad ( BtoA2 )}%
\@pvspace{8.0pt}%
\@x{ NextH \.{\defeq} \.{\land} AB2 {\bang} Next}%
\@x{\@s{47.95} \.{\land} AtoB \.{'} \.{=} RemoveBad ( AtoB2 \.{'} )}%
\@x{\@s{47.95} \.{\land} BtoA \.{'}\@s{0.77} \.{=} RemoveBad ( BtoA2 \.{'} )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 We would normally define \ensuremath{varsH} to be the tuple of all the
 variables of
...
\begin{cpar}{0}{T}{F}{7.5}{0}{}%
 \ensuremath{{\UNCHANGED} {\langle} {\langle}AVar,\, \.{\dots} ,\,
 BtoA2{\rangle},\, AtoB,\, BtoA {\rangle}
}%
\end{cpar}%
\vshade{5.0}%
...
\vshade{5.0}%
\begin{cpar}{0}{T}{F}{7.5}{0}{}%
 \ensuremath{{\UNCHANGED} {\langle} AVar,\, \.{\dots} ,\, BtoA2,\, AtoB,\,
 BtoA {\rangle}
}%
\end{cpar}%
\end{lcom}%
\@x{ varsH \.{\defeq} {\langle} AB2 {\bang} vars ,\, AtoB ,\, BtoA {\rangle}}%
\@pvspace{8.0pt}%
\@x{ SpecHH \.{\defeq} InitH \.{\land} {\Box} [ NextH ]_{ varsH}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 The following theorem asserts that \ensuremath{SpecHH} and \ensuremath{SpecH}
 are equivalent
 specifications. It is equivalent to
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{T}{F}{7.5}{0}{}%
\ensuremath{\.{\land} SpecHH \.{\implies} SpecH
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\land} SpecH \.{\implies} SpecHH
}%
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{1}{F}{F}{0}{0}{}%
 \ensuremath{TLC} can check the first of these implications by showing that
 \ensuremath{SpecH} is
 a property satisfied by the specification \ensuremath{SpecHH}, but not the
 second.
\end{cpar}%
\end{lcom}%
\@x{ {\THEOREM} SpecHH \.{\equiv} SpecH}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 We can deduce that \ensuremath{SpecH} implies \ensuremath{AB{\bang}Spec} from
 \ensuremath{SpecHH \.{\equiv} SpecH} and the
 following theorem, which \ensuremath{TLC} can check.
\end{cpar}%
\end{lcom}%
\@x{ {\THEOREM} SpecHH \.{\implies} AB {\bang} Spec}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 21:51:02 \ensuremath{CST} 2022 by \ensuremath{wengjialin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun May 13 23:53:20
 \ensuremath{PDT} 2018 by \ensuremath{lamport
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
