...
\@x{}\moduleLeftDash\@xx{ {\MODULE} wire}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Integers}%
\@pvspace{8.0pt}%
\pcalsymbolstrue
\pcalshadingtrue
\csyntaxfalse
\@x{\@s{8.2} {\p@mmalgorithm} wire}%
\@x{ {\p@variables}}%
\@x{\@s{16.4} people \.{=} \{\@w{alice} ,\,\@w{bob} \} ,\,}%
\@x{\@s{16.4} acc \.{=} [ p \.{\in} people \.{\mapsto} 5 ] {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{ {\p@define}}%
 \@x{\@s{16.4} NoOverdrafts \.{\defeq} \A\, p \.{\in} people \.{:} acc [ p ]
 \.{\geq} 0}%
 \@x{\@s{16.4} EventuallyConsistent \.{\defeq} {\Diamond} {\Box} ( acc
 [\@w{alice} ] \.{+} acc [\@w{bob} ] \.{=} 10 )}%
\@x{ {\p@end} {\p@define} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{ {\p@process} Wire \.{\in} 1 \.{\dotdot} 2}%
\@x{\@s{16.4} {\p@variables}}%
\@x{\@s{32.8} sender \.{=}\@w{alice} ,\,}%
\@x{\@s{32.8} receiver \.{=}\@w{bob} ,\,}%
\@x{\@s{32.8} amount \.{\in} 1 \.{\dotdot} acc [ sender ] {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{ {\p@begin}}%
\@x{\@s{16.4} CheckAndWithdraw\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{32.8} {\p@if} amount \.{\leq} acc [ sender ] {\p@then}}%
 \@x{\@s{63.84} acc [ sender ] \.{:=} acc [ sender ] \.{-} amount
 {\p@semicolon}}%
\@x{\@s{47.44} Deposit\@s{.5}\textrm{:}\@s{3}}%
 \@x{\@s{63.84} acc [ receiver ] \.{:=} acc [ receiver ] \.{+} amount
 {\p@semicolon}}%
...
\@x{}%
\@y{\@s{0}%
 BEGIN TRANSLATION (\ensuremath{chksum(pcal) \.{=}} ``\ensuremath{1cf0c5b2}''
 \ensuremath{\.{\land} chksum(tla) \.{=}} ``\ensuremath{9b2bfebc}'')
}%
\@xx{}%
\@x{ {\VARIABLES} people ,\, acc ,\, pc}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 define statement
...
\@xx{}%
 \@x{ NoOverdrafts \.{\defeq} \A\, p \.{\in} people \.{:} acc [ p ] \.{\geq}
 0}%
 \@x{ EventuallyConsistent \.{\defeq} {\Diamond} {\Box} ( acc [\@w{alice} ]
 \.{+} acc [\@w{bob} ] \.{=} 10 )}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES} sender ,\, receiver ,\, amount}%
\@pvspace{8.0pt}%
 \@x{ vars \.{\defeq} {\langle} people ,\, acc ,\, pc ,\, sender ,\, receiver
 ,\, amount {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ProcSet \.{\defeq} ( 1 \.{\dotdot} 2 )}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
\@y{\@s{0}%
 Global variables
...
\@xx{}%
\@x{\@s{35.70} \.{\land} people \.{=} \{\@w{alice} ,\,\@w{bob} \}}%
\@x{\@s{35.70} \.{\land} acc \.{=} [ p \.{\in} people \.{\mapsto} 5 ]}%
\@x{\@s{35.70}}%
\@y{\@s{0}%
 Process \ensuremath{Wire
}}%
\@xx{}%
 \@x{\@s{35.70} \.{\land} sender \.{=} [ self \.{\in} 1 \.{\dotdot} 2
 \.{\mapsto}\@w{alice} ]}%
 \@x{\@s{35.70} \.{\land} receiver \.{=} [ self \.{\in} 1 \.{\dotdot} 2
 \.{\mapsto}\@w{bob} ]}%
 \@x{\@s{35.70} \.{\land} amount \.{\in} [ 1 \.{\dotdot} 2 \.{\rightarrow} 1
 \.{\dotdot} acc [ sender [ {\CHOOSE} self \.{\in}\@s{4.1} 1 \.{\dotdot} 2
 \.{:} {\TRUE} ] ] ]}%
 \@x{\@s{35.70} \.{\land} pc \.{=} [ self \.{\in} ProcSet
 \.{\mapsto}\@w{CheckAndWithdraw} ]}%
\@pvspace{8.0pt}%
 \@x{ CheckAndWithdraw ( self ) \.{\defeq} \.{\land} pc [ self ]
 \.{=}\@w{CheckAndWithdraw}}%
 \@x{\@s{129.70} \.{\land} {\IF} amount [ self ]\@s{3.94} \.{\leq} acc [
 sender [ self ] ]}%
 \@x{\@s{152.96} \.{\THEN} \.{\land} acc \.{'} \.{=} [ acc {\EXCEPT} {\bang} [
 sender [ self ] ] \.{=} acc [ sender [ self ] ] \.{-} amount [ self ] ]}%
 \@x{\@s{184.27} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{Deposit} ]}%
 \@x{\@s{152.96} \.{\ELSE} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [
 self ] \.{=}\@w{Done} ]}%
\@x{\@s{184.27} \.{\land} acc \.{'} \.{=} acc}%
 \@x{\@s{129.70} \.{\land} {\UNCHANGED} {\langle} people ,\, sender ,\,
 receiver ,\, amount {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Deposit ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{Deposit}}%
 \@x{\@s{76.38} \.{\land} acc \.{'} \.{=} [ acc {\EXCEPT} {\bang} [ receiver [
 self ] ] \.{=} acc [ receiver [ self ] ] \.{+} amount [ self ] ]}%
 \@x{\@s{76.38} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{Done} ]}%
 \@x{\@s{76.38} \.{\land} {\UNCHANGED} {\langle} people ,\, sender ,\,
 receiver ,\, amount {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ Wire ( self ) \.{\defeq} CheckAndWithdraw ( self ) \.{\lor} Deposit (
 self )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@pvspace{8.0pt}%
 \@x{ Next \.{\defeq} ( \E\, self \.{\in} 1 \.{\dotdot} 2 \.{:} Wire ( self )
 )}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun \ensuremath{Aug} 07
 10:17:17 \ensuremath{CST} 2022 by \ensuremath{wengjialin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sat \ensuremath{Aug} 06 11:33:28
