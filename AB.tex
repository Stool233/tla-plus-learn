...
\begin{document}
\tlatex
\@x{}\moduleLeftDash\@xx{ {\MODULE} AB}\moduleRightDash\@xx{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 We first define \ensuremath{Remove(i,\, seq)} to be the sequence obtained by
 removing
 element number \ensuremath{i} from sequence \ensuremath{seq}.
\end{cpar}%
\end{lcom}%
\@x{ Remove ( i ,\, seq ) \.{\defeq}}%
 \@x{\@s{8.2} [ j \.{\in} 1 \.{\dotdot} ( Len ( seq ) \.{-} 1 ) \.{\mapsto}
 {\IF} j \.{<} i \.{\THEN} seq [ j ]}%
\@x{\@s{159.43} \.{\ELSE} seq [ j \.{+} 1 ] ]}%
\@pvspace{8.0pt}%
...
\@xx{}%
\@pvspace{8.0pt}%
\@x{ vars \.{\defeq} {\langle} AVar ,\, BVar ,\, AtoB ,\, BtoA {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ TypeOK \.{\defeq} \.{\land} AVar\@s{0.62} \.{\in} Data \.{\times} \{ 0
 ,\, 1 \}}%
\@x{\@s{56.14} \.{\land} BVar \.{\in} Data \.{\times} \{ 0 ,\, 1 \}}%
 \@x{\@s{56.14} \.{\land} AtoB\@s{0.43} \.{\in} Seq ( Data \.{\times} \{ 0 ,\,
 1 \} )}%
\@x{\@s{56.14} \.{\land} BtoA\@s{1.20} \.{\in} Seq ( \{ 0 ,\, 1 \} )}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq} \.{\land} AVar\@s{0.62} \.{\in} Data \.{\times} \{ 1 \}}%
\@x{\@s{35.70} \.{\land} BVar \.{=} AVar}%
\@x{\@s{35.70} \.{\land} AtoB\@s{0.43} \.{=} {\langle} {\rangle}}%
\@x{\@s{35.70} \.{\land} BtoA\@s{1.20} \.{=} {\langle} {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 The action of the sender sending a data message by appending
 \ensuremath{AVar} to
 the end of the message queue \ensuremath{AtoB}. It will keep sending the same
 message until it receives an acknowledgment for it from the receiver.
\end{cpar}%
\end{lcom}%
\@x{ ASnd \.{\defeq} \.{\land} AtoB \.{'} \.{=} Append ( AtoB ,\, AVar )}%
 \@x{\@s{43.71} \.{\land} {\UNCHANGED} {\langle} AVar ,\, BtoA ,\, BVar
 {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
The action of the sender receiving an ack message. If that ack is for
 ...
 from \ensuremath{BtoA}.
\end{cpar}%
\end{lcom}%
\@x{ ARcv \.{\defeq} \.{\land} BtoA \.{\neq} {\langle} {\rangle}}%
\@x{\@s{43.38} \.{\land} {\IF} Head ( BtoA ) \.{=} AVar [ 2 ]}%
 \@x{\@s{62.69} \.{\THEN} \E\, d \.{\in} Data \.{:} AVar \.{'} \.{=} {\langle}
 d ,\, 1 \.{-} AVar [ 2 ] {\rangle}}%
\@x{\@s{62.69} \.{\ELSE} AVar \.{'} \.{=} AVar}%
\@x{\@s{43.38} \.{\land} BtoA \.{'} \.{=} Tail ( BtoA )}%
\@x{\@s{43.38} \.{\land} {\UNCHANGED} {\langle} AtoB ,\, BVar {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{ BSnd \.{\defeq} \.{\land} BtoA \.{'} \.{=} Append ( BtoA ,\, BVar [ 2 ]
 )}%
 \@x{\@s{43.31} \.{\land} {\UNCHANGED} {\langle} AVar ,\, BVar ,\, AtoB
 {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 The action of the receiver receiving a data message. It sets
 \ensuremath{BVar} to
 that message if it\mbox{'}s not for the data item it has already received.
\end{cpar}%
\end{lcom}%
\@x{ BRcv \.{\defeq} \.{\land} AtoB \.{\neq} {\langle} {\rangle}}%
\@x{\@s{42.98} \.{\land} {\IF} Head ( AtoB ) [ 2 ] \.{\neq} BVar [ 2 ]}%
\@x{\@s{62.29} \.{\THEN} BVar \.{'} \.{=} Head ( AtoB )}%
\@x{\@s{62.29} \.{\ELSE} BVar \.{'} \.{=} BVar}%
\@x{\@s{42.98} \.{\land} AtoB \.{'} \.{=} Tail ( AtoB )}%
\@x{\@s{42.98} \.{\land} {\UNCHANGED} {\langle} AVar ,\, BtoA {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{LoseMsg} is the action that removes an arbitrary message from
 queue \ensuremath{AtoB
} or \ensuremath{BtoA}.
\end{cpar}%
\end{lcom}%
 \@x{ LoseMsg \.{\defeq} \.{\land} \.{\lor} \.{\land} \E\, i \.{\in} 1
 \.{\dotdot} Len ( AtoB ) \.{:}}%
\@x{\@s{101.63} AtoB \.{'} \.{=} Remove ( i ,\, AtoB )}%
\@x{\@s{79.21} \.{\land} BtoA \.{'} \.{=} BtoA}%
 \@x{\@s{68.10} \.{\lor} \.{\land} \E\, i \.{\in} 1 \.{\dotdot} Len ( BtoA )
 \.{:}}%
\@x{\@s{101.63} BtoA \.{'} \.{=} Remove ( i ,\, BtoA )}%
\@x{\@s{79.21} \.{\land} AtoB \.{'} \.{=} AtoB}%
\@x{\@s{56.98} \.{\land} {\UNCHANGED} {\langle} AVar ,\, BVar {\rangle}}%
\@pvspace{8.0pt}%
...
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{FairSpec} is \ensuremath{Spec} with fairness conditions added.
\end{cpar}%
\end{lcom}%
 \@x{ FairSpec \.{\defeq} Spec\@s{4.1} \.{\land}\@s{4.1} {\SF}_{ vars} ( ARcv
 )\@s{5.05} \.{\land} {\SF}_{ vars} ( BRcv ) \.{\land}}%
\@x{\@s{95.30} {\WF}_{ vars} ( ASnd ) \.{\land} {\WF}_{ vars} ( BSnd )}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 19:31:09 \ensuremath{CST} 2022 by \ensuremath{wengjialin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Wed}
 \ensuremath{Dec} 27 13:29:51 \ensuremath{PST} 2017 by \ensuremath{lamport
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
