...
\* BEGIN TRANSLATION (chksum(pcal) = "de213694" /\ chksum(tla) = "bda9bb3d")
...
Schedule == /\ pc[Reducer] = "Schedule"
            /\ LET worker_order == PT!OrderSet(Workers) IN
                 ...
                 /\ assignments' = queue'
                 /\ \E w \in {w \in ActiveWorkers: Len(queue'[w]) = 0}:
...
\* Last modified Sat Nov 26 19:40:29 CST 2022 by wengjialin
