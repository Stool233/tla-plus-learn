...
\@x{}\moduleLeftDash\@xx{ {\MODULE} dekker}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} TLC ,\, Integers}%
\@x{ {\CONSTANT} Threads}%
\@pvspace{8.0pt}%
\pcalsymbolstrue
\pcalshadingtrue
\csyntaxfalse
\@x{\@s{8.2} {\p@mmalgorithm} dekker}%
\@x{ {\p@variables}}%
\@x{\@s{16.4} flag \.{=} [ t \.{\in} Threads \.{\mapsto} {\FALSE} ] ,\,}%
\@x{\@s{16.4} next\_thread \.{\in} Threads {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{ {\p@fair} {\p@process} thread \.{\in} Threads}%
\@x{ {\p@begin}}%
 \@x{\@s{16.4} P1\@s{.5}\textrm{:}\@s{3} flag [ self ] \.{:=} {\TRUE}
 {\p@semicolon}}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\@s{16.4} P2\@s{.5}\textrm{:}\@s{3}}%
 \@x{\@s{36.65} {\p@while} \E\, t \.{\in} Threads \.{\,\backslash\,} \{ self
 \} \.{:} flag [ t ] {\p@do}}%
\@x{\@s{53.05} P2\_1\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{69.45} {\p@if} next\_thread \.{\neq} self {\p@then}}%
 \@x{\@s{84.09} P2\_1\_1\@s{.5}\textrm{:}\@s{3} flag [ self ] \.{:=} {\FALSE}
 {\p@semicolon}}%
 \@x{\@s{84.09} P2\_1\_2\@s{.5}\textrm{:}\@s{3} {\p@await} next\_thread \.{=}
 self {\p@semicolon}}%
 \@x{\@s{84.09} P2\_1\_3\@s{.5}\textrm{:}\@s{3} flag [ self ] \.{:=} {\TRUE}
 {\p@semicolon}}%
\@x{\@s{69.45} {\p@end} {\p@if} {\p@semicolon}}%
\@x{\@s{36.65} {\p@end} {\p@while} {\p@semicolon}}%
\@x{\@s{16.4} CS\@s{.5}\textrm{:}\@s{3} {\p@skip} {\p@semicolon}}%
\@x{\@s{16.4} P3\@s{.5}\textrm{:}\@s{3}}%
 \@x{\@s{35.48} {\p@with} t \.{\in} Threads \.{\,\backslash\,} \{ self \}
 {\p@do}}%
\@x{\@s{51.88} next\_thread \.{:=} t {\p@semicolon}}%
\@x{\@s{35.48} {\p@end} {\p@with} {\p@semicolon}}%
 \@x{\@s{16.4} P4\@s{.5}\textrm{:}\@s{3} flag [ self ] \.{:=} {\FALSE}
 {\p@semicolon}}%
\@x{\@s{16.4} P5\@s{.5}\textrm{:}\@s{3} {\p@goto} P1 {\p@semicolon}}%
...
\@x{}%
\@y{\@s{0}%
 BEGIN TRANSLATION (\ensuremath{chksum(pcal) \.{=}} ``31494451''
 \ensuremath{\.{\land} chksum(tla) \.{=}} ``\ensuremath{97685e2c}'')
}%
\@xx{}%
\@x{ {\VARIABLES} flag ,\, next\_thread ,\, pc}%
\@pvspace{8.0pt}%
\@x{ vars \.{\defeq} {\langle} flag ,\, next\_thread ,\, pc {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ProcSet \.{\defeq} ( Threads )}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
\@y{\@s{0}%
 Global variables
...
\@xx{}%
 \@x{\@s{35.70} \.{\land} flag \.{=} [ t \.{\in} Threads \.{\mapsto} {\FALSE}
 ]}%
\@x{\@s{35.70} \.{\land} next\_thread \.{\in} Threads}%
 \@x{\@s{35.70} \.{\land} pc \.{=} [ self \.{\in} ProcSet \.{\mapsto}\@w{P1}
 ]}%
\@pvspace{8.0pt}%
\@x{ P1 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{P1}}%
 \@x{\@s{55.90} \.{\land} flag \.{'} \.{=} [ flag {\EXCEPT} {\bang} [ self ]
 \.{=} {\TRUE} ]}%
 \@x{\@s{55.90} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{P2} ]}%
\@x{\@s{55.90} \.{\land} {\UNCHANGED} next\_thread}%
\@pvspace{8.0pt}%
\@x{ P2 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{P2}}%
 \@x{\@s{55.90} \.{\land} {\IF} \E\, t \.{\in} Threads \.{\,\backslash\,} \{
 self \} \.{:} flag [ t ]}%
 \@x{\@s{79.17} \.{\THEN} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [
 self ] \.{=}\@w{P2\_1} ]}%
 \@x{\@s{79.17} \.{\ELSE} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [
 self ] \.{=}\@w{CS} ]}%
 \@x{\@s{55.90} \.{\land} {\UNCHANGED} {\langle} flag ,\, next\_thread
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ P2\_1 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{P2\_1}}%
\@x{\@s{65.40} \.{\land} {\IF} next\_thread\@s{3.87} \.{\neq} self}%
 \@x{\@s{88.67} \.{\THEN} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [
 self ] \.{=}\@w{P2\_1\_1} ]}%
 \@x{\@s{88.67} \.{\ELSE} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [
 self ] \.{=}\@w{P2} ]}%
 \@x{\@s{65.40} \.{\land} {\UNCHANGED} {\langle} flag ,\, next\_thread
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ P2\_1\_1 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{P2\_1\_1}}%
 \@x{\@s{74.90} \.{\land} flag \.{'} \.{=} [ flag {\EXCEPT} {\bang} [ self ]
 \.{=} {\FALSE} ]}%
 \@x{\@s{74.90} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{P2\_1\_2} ]}%
\@x{\@s{74.90} \.{\land} {\UNCHANGED} next\_thread}%
\@pvspace{8.0pt}%
\@x{ P2\_1\_2 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{P2\_1\_2}}%
\@x{\@s{74.90} \.{\land} next\_thread \.{=} self}%
 \@x{\@s{74.90} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{P2\_1\_3} ]}%
 \@x{\@s{74.90} \.{\land} {\UNCHANGED} {\langle} flag ,\, next\_thread
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ P2\_1\_3 ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{P2\_1\_3}}%
 \@x{\@s{74.90} \.{\land} flag \.{'} \.{=} [ flag {\EXCEPT} {\bang} [ self ]
 \.{=} {\TRUE} ]}%
 \@x{\@s{74.90} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{P2} ]}%
...
\@x{\@s{57.07} \.{\land} {\TRUE}}%
 \@x{\@s{57.07} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{P3} ]}%
 \@x{\@s{57.07} \.{\land} {\UNCHANGED} {\langle} flag ,\, next\_thread
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ P3 ( self )\@s{1.16} \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{P3}}%
 \@x{\@s{57.07} \.{\land} \E\, t \.{\in} Threads \.{\,\backslash\,} \{ self \}
 \.{:}}%
\@x{\@s{76.38} next\_thread \.{'} \.{=} t}%
 \@x{\@s{57.07} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{P4} ]}%
\@x{\@s{57.07} \.{\land} flag \.{'} \.{=} flag}%
\@pvspace{8.0pt}%
\@x{ P4 ( self )\@s{1.16} \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{P4}}%
 \@x{\@s{57.07} \.{\land} flag \.{'} \.{=} [ flag {\EXCEPT} {\bang} [ self ]
 \.{=} {\FALSE} ]}%
 \@x{\@s{57.07} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{P5} ]}%
\@x{\@s{57.07} \.{\land} {\UNCHANGED} next\_thread}%
\@pvspace{8.0pt}%
\@x{ P5 ( self )\@s{1.16} \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{P5}}%
 \@x{\@s{57.07} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{P1} ]}%
 \@x{\@s{57.07} \.{\land} {\UNCHANGED} {\langle} flag ,\, next\_thread
 {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ thread ( self ) \.{\defeq} P1 ( self ) \.{\lor} P2 ( self ) \.{\lor}
 P2\_1 ( self )\@s{8.18} \.{\lor} P2\_1\_1 ( self )}%
 \@x{\@s{87.27} \.{\lor} P2\_1\_2 ( self ) \.{\lor} P2\_1\_3 ( self ) \.{\lor}
 CS ( self ) \.{\lor} P3 ( self )}%
\@x{\@s{87.27} \.{\lor} P4 ( self ) \.{\lor} P5 ( self )}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} ( \E\, self \.{\in} Threads \.{:} thread ( self ) )}%
\@x{\@s{47.82} \.{\lor} Terminating}%
\@pvspace{8.0pt}%
 \@x{ Spec\@s{1.46} \.{\defeq} \.{\land} Init \.{\land} {\Box} [ Next ]_{
 vars}}%
 \@x{\@s{39.83} \.{\land} \A\, self \.{\in} Threads \.{:} {\WF}_{ vars} (
 thread ( self ) )}%
\@pvspace{8.0pt}%
...
\@xx{}%
\@pvspace{8.0pt}%
\@x{ AtMostOneCritical \.{\defeq}}%
\@x{\@s{16.4} \A\, t1 ,\, t2 \.{\in} Threads \.{:}}%
 \@x{\@s{27.72} t1 \.{\neq} t2 \.{\implies} {\lnot} ( pc [ t1 ] \.{=}\@w{CS}
 \.{\land} pc [ t2 ] \.{=}\@w{CS} )}%
\@pvspace{8.0pt}%
\@x{ Liveness \.{\defeq}}%
\@x{\@s{16.4} \A\, t \.{\in} Threads \.{:}}%
\@x{\@s{27.72} {\Diamond} ( pc [ t ] \.{=}\@w{CS} )}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun \ensuremath{Sep} 04
 11:47:01 \ensuremath{CST} 2022 by \ensuremath{wengjialin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sun \ensuremath{Sep} 04 10:39:45
