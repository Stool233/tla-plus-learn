...
\* BEGIN TRANSLATION (chksum(pcal) = "61dcd498" /\ chksum(tla) = "b66bfe86")
...
thread(self) == P1(self) \/ P2(self) \/ P2_1_1(self) \/ P2_1_2(self)
                   \/ P2_1_3(self) \/ CS(self) \/ P3(self) \/ P4(self)
                   \/ P5(self)
...
\* Last modified Sun Sep 04 11:40:18 CST 2022 by wengjialin
\* Created Sun Sep 04 10:39:45 CST 2022 by wengjialin
